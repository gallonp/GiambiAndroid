...
public class TransactionPresenter {
    ...
    public TransactionPresenter(TransactionView v, String accountNumber) {
        ...
        this.transactions = Transaction.getAccountTransactions(username,
                this.accountNumber);
        Log.v("transactions to present", transactions.size() + "");
        // if (transactions != null){
        // this.transactions.get(0).createDate =
        // Calendar.getInstance().getTime();
        // this.transactions.get(1).createDate =
        // Calendar.getInstance().getTime();
        // this.transactions.get(2).createDate =
        // Calendar.getInstance().getTime();
